    ...
    public static class DepotDistanceCustomerDifficultyWeight
        ...
        private static final Comparator<DepotDistanceCustomerDifficultyWeight> COMPARATOR =
                ...
                comparingLong((DepotDistanceCustomerDifficultyWeight weight) -> weight.depotRoundTripDistance)
                        ...
                        .thenComparingDouble(weight -> weight.customer.getLocation().getStart().getLatitude())
                        .thenComparingDouble(weight -> weight.customer.getLocation().getStart().getLongitude())
                        .thenComparingDouble(weight -> weight.customer.getLocation().getEnd().getLatitude())
                        .thenComparingDouble(weight -> weight.customer.getLocation().getEnd().getLongitude())

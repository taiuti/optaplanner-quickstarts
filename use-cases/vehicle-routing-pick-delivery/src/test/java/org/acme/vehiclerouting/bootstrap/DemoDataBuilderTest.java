...
class DemoDataBuilderTest {
    ...
    void map_corner_test() {
        DemoDataBuilder builder = correctBuilder().setSouthWestCorner(new AirLocation(0L,"", new Point(0L,"", 2, 1)));
        builder.setNorthEastCorner(new AirLocation(0L,"", new Point(0L,"",1, 2)));
        assertThrows(IllegalStateException.class, builder::build);

        builder = correctBuilder().setSouthWestCorner(new AirLocation(0L,"", new Point(0L,"", 1, 1)));
        builder.setNorthEastCorner(new AirLocation(0L,"", new Point(0L,"", 1, 2)));
        assertThrows(IllegalStateException.class, builder::build);

        builder = correctBuilder().setSouthWestCorner(new AirLocation(0L,"", new Point(0L,"", 1, 1)));
        builder.setNorthEastCorner(new AirLocation(0L,"", new Point(0L,"", 2, 1)));
        assertThrows(IllegalStateException.class, builder::build);

        builder = correctBuilder().setSouthWestCorner(new AirLocation(0L,"", new Point(0L,"", 1, 2)));
        builder.setNorthEastCorner(new AirLocation(0L,"", new Point(0L,"", 2, 1)));
        assertThrows(IllegalStateException.class, builder::build);
    }
